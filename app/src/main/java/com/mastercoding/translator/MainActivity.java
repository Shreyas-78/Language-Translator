...
public class MainActivity extends AppCompatActivity {
    ...
    String[] fromLanguages = {"from", "English", "Spanish", "Kannada", "French", "Japanese", "Russian", "Hindi", "Urdu","Chinese","Telugu","Tamil"};
    String[] toLanguages = {"to","English", "Spanish", "Kannada", "French", "Japanese", "Russian", "Hindi", "Urdu","Chinese","Telugu","Tamil"};
